...
pub(crate) fn initialize_compositor(globals: &GlobalManager) -> Proxy<WlCompositor> {
    globals
...
pub(crate) fn initialize_subcompositor(globals: &GlobalManager) -> Proxy<WlSubcompositor> {
    globals
